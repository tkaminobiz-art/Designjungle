        ...
        <section className="origin" id="origin">
          <div className="inner origin__grid">
            ...
            <div className="origin__text">
              <p className="reveal">
                「デザイン」は、ロゴやWebだけを指す言葉ではありません。事業モデルをつくることも、商品の見せ方を整えることも、地域の動きを組み立てることも、私たちはデザインだと考えています。
              </p>
              <p className="reveal">
                「ジャングル」は、多様なものが混ざり合い、それぞれの個性を発揮しながらひとつの生態系をつくる場所。いろんな事業と人が交差し、新しい価値が育つ場所でありたいという想いを込めています。
              </p>
            </div>
          </div>
        </section>
