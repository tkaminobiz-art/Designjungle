  ...
  return (
    <>
      ...
      <div className={`loader ${isReturning ? "loader--returning" : ""} ${isLoaded ? "is-hidden" : ""}`} aria-hidden="true">
        ...
        />
        <img className="loader__fallback" src="/images/design-jungle-logo-transparent.png" alt="" />
      </div>
        ...
        <section className="origin" id="origin">
          <div className="inner origin__grid">
            ...
            <div className="origin__text">
              <p className="reveal">
                「デザイン」は、見た目を整えるためだけの言葉ではありません。事業の組み立て方、商品の見せ方、地域に届く導線までを考えること。私たちはそこまで含めて、デザインと捉えています。
              </p>
              <p className="reveal">
